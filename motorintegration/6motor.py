...
class MotorControlNode(Node):
    def __init__(self):
        ...
        # PWM channels for six motors (RPWM and LPWM per motor)
        self.pwm_channels = {
            ...
            'motor4_r': 6,   # Right PWM for Motor 4
            'motor4_l': 7,   # Left PWM for Motor 4
            'motor5_r': 8,   # Right PWM for Motor 5
            'motor5_l': 9,   # Left PWM for Motor 5
            'motor6_r': 10,  # Right PWM for Motor 6
            'motor6_l': 11   # Left PWM for Motor 6
        }
        ...
        self.get_logger().info("Motor control node initialized for 6 motors with terminal input. Lift motors before starting! Use 'F <speed>', 'B <speed>', or 'S'.")
    ...
    def set_all_motor_speeds(self, speed, direction=1):
        """Set PWM for all six motors with the same speed and direction"""
        for motor_id in range(1, 7):  # Motors 1 through 6
